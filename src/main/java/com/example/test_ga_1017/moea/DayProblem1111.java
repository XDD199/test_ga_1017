...
public class DayProblem1111 extends AbstractProblem {
    ...
    public void evaluate(Solution solution) {
        ...
        fout[6] = (abs(f[5] - 262.4) + abs(f[5] - 820) - (820 - 262.4)) / max.getVita()
                + (abs(f[13] - 3.68) + abs(f[13] - 10.028) - (10.028 - 3.68)) / max.getZn();//vita+zn

        fout[7] = (abs(f[4] - 7) + abs(f[4] - 30) - (30 - 7)) / max.getDf()
                + (abs(f[8] - 32) + abs(f[8] - 480) - (480 - 32)) / max.getVitc()
                + (f[9] > 672 ? 0 : 672 - f[9]) / max.getK()
                + (f[12] > 102.4 ? 0 : 102.4 - f[12]) / max.getMg();//df  vitc k mg

        fout[8] = (f[6] > 0.512 ? 0 : 0.512 - f[6]) / max.getVitb1()
                + (f[7] > 0.512 ? 0 : 0.512 - f[7]) / max.getVitb2()
                + (abs(f[10] - 512) + abs(f[10] - 832) - (832 - 512)) / max.getNa(); //vitb1 vitb2 na
